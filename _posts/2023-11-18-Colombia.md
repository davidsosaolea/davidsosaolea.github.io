...
Utilizamos la biblioteca Selenium para automatizar la descarga de archivos en formato Excel desde el sitio web [https://snies.mineducacion.gov.co](https://snies.mineducacion.gov.co). Esta técnica es especialmente útil cuando se requiere extraer datos para análisis posterior.
...
## __GITHUB__
se puede enconctrar el nootebok en [mi github](https://github.com/davidsosaolea/IES_colombia/tree/main)
