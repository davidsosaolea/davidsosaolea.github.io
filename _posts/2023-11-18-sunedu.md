...
## __GITHUB__
En mi [mi github](https://github.com/davidsosaolea/){:target="_blank"}puedes encontrar el código de lectura de archivos PDF y el web scraping realizado para la página web de SUNEDU.